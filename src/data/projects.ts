...
export const PROJECTS: Project[] = [
    ...
    },
    {
        ...
        tagline: 'Visualizing systematic polling biases across different organizations using small multiples.',
        description: 'A long-form visual explainer highlighting "House Effects"—the consistent, systematic deviations that different polling organizations exhibit relative to the aggregate average. The project demonstrates how plotting longitudinal data from multiple sources reveals these structural biases.',
        imageSrc: '/images/projects/project-1/06_house_effects_small_multiples.png',
        challenge: 'The "House Effect" describes a systematic bias where a specific polling firm consistently overestimates or underestimates support for a particular party. Unlike random sampling noise, which fluctuates symmetrically, house effects present as persistent offsets. The objective was to communicate these structural deviations, which are typically obscured within aggregate polling averages.',
        solution: 'Applying a small multiples approach—separating polling data by organization into distinct, uniform charts—makes the systematic biases visually apparent. This architecture enables direct, comparative analysis of trend lines over time across different methodological sources.',
        result: 'The visualization clarifies distinct, non-random variations. The data shows that Gallup consistently measures higher support for the Independence Party compared to the aggregate, whereas Maskína measures lower support. These systematic deviations stem from underlying methodological differences, primarily variations in panel composition, sampling frames, and demographic weighting models.',
